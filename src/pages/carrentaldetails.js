...
const CarRentalDetails = () => {
  ...
  const [filters, setFilters] = useState({
    type: ["Standard", "Compact", "Medium", "Large", "SUV"], // All types selected
    supplier: ["Alamo", "National", "dollar", "Thrifty", "Hertz"], // All suppliers selected
    minPrice: 0,
    maxPrice: 200,
    passengers: [4, 5, 7], // All passenger options selected
  });
